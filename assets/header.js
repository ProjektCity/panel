document.addEventListener('DOMContentLoaded', function() {
    ...
    header.innerHTML = `
        <div class="header-inner">
            <div class="header-box" data-linkout="/"><div class="flex-container"><div class="header-logo"></div><div class="panel-name"><span>Projekt City</span> Panel</div></div></div>
            <div class="header-box" style="display: flex; justify-content: center; width: 50%;"><div class="header-menu"><div class="header-item"><a href="/">Dashboard</a></div><div class="header-item"><a href="/tasks.html">Tasks</a></div><div class="header-item"><a href="/changelog.html">Changelog</a></div><div class="header-item"><a href="/inbox.html">Inbox</a></div></div></div>
